...
class QuestionController extends Controller
{
    ...
    public function index()
    {
       $categories = Category::where('status','Active')->get();
        return view('admin.question.index')->with('categories',$categories);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.question.show')->with('data',$data);
    }
    ...
    public function optionFetch(Request $request)
    {

       $data = QuestionOption::where('question_id',$request->id)->orderBy('id','desc')->get();
       return DataTables::of($data)
        ->addColumn('status',function($data){
          if($data->status=='Disable') {
            return '<span class="label label-danger">Disable</span>';
