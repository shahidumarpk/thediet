...
<!-- Bootstrap 3.3.7 -->
    <script src="{{ asset('public/bower_components/bootstrap/dist/js/bootstrap.min.js') }}" defer></script>

<!-- iCheck -->
<script src="{{ asset('public/plugins/iCheck/icheck.min.js') }}" defer></script>
